...
export default class Client {
  ...
  public getMessages(deviceId: string): Promise<any> {
  ...
  public transferMultipleDevices(params: transferMultipleDevicesParams): Promise<any> {
  ...
  public updateDeviceType(deviceTypeId: string, params: updateDeviceTypeParams): Promise<any> {
  ...
  public getCallbacksNotDelivered(deviceTypeId: string, callbackId: string): Promise<any> {
    return this.http.get(`/device-types/${deviceTypeId}/callbacks/${callbackId}/callbacks-not-delivered`)
  }
